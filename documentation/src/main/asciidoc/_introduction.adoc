...
of Jakarta Validation. The test suite is built atop JUnit 6 (Jupiter) and provides a series
...
collection of JUnit tests, the JUnit test suite configuration and
...
container and pass with an unmodified JUnit test suite.
