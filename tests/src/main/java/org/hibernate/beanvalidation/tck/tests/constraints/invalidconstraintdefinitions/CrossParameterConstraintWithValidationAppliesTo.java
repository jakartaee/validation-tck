 ...
 */
@Documented
@Constraint(validatedBy = { CrossParameterConstraintWithValidationAppliesTo.Validator.class })
@Target({ METHOD, CONSTRUCTOR, TYPE, FIELD })
@Retention(RUNTIME)
public @interface CrossParameterConstraintWithValidationAppliesTo {
