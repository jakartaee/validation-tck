...
@Constraint(validatedBy = {
		ConstraintWithTwoValidatorsForTheSameType.Validator.class,
		ConstraintWithTwoValidatorsForTheSameType.AnotherValidator.class
})
@Target({ METHOD, CONSTRUCTOR, TYPE, FIELD })
@Retention(RUNTIME)
public @interface ConstraintWithTwoValidatorsForTheSameType {
