 ...
 */
public class UserWithContainerElementGroupConversionButWithoutValidAnnotationOnMethodParameter {

	public void setAddresses(List<@ConvertGroup(from = Default.class, to = BasicPostal.class) Address> addresses) {
	}
}
