...
public class ReservedPayloadElementNameTest extends AbstractTCKTest {

	private static final String PACKAGE_NAME = "/org/hibernate/beanvalidation/tck/tests/xmlconfiguration/constraintdeclaration/";
	private static final String MAPPING_FILE = "constraints-PayloadIsNotAllowedAsElementNameTest.xml";

	@Deployment
	public static WebArchive createTestArchive() {
		return webArchiveBuilder()
				.withTestClass( ReservedPayloadElementNameTest.class )
