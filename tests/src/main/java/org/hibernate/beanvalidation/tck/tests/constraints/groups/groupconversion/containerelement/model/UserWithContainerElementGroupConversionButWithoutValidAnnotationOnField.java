 ...
 */
public class UserWithContainerElementGroupConversionButWithoutValidAnnotationOnField {

	@SuppressWarnings("unused")
	private final List<@ConvertGroup(from = Default.class, to = BasicPostal.class) Address> addresses = null;
}
