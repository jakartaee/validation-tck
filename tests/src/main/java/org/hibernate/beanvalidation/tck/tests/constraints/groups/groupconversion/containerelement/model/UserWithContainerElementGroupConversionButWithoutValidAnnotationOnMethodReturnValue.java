 ...
 */
public class UserWithContainerElementGroupConversionButWithoutValidAnnotationOnMethodReturnValue {

	public List<@ConvertGroup(from = Default.class, to = BasicPostal.class) Address> retrieveAddresses() {
		return null;
	}
}
