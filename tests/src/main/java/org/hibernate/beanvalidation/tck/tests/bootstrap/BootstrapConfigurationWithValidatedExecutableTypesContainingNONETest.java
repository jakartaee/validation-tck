...
public class BootstrapConfigurationWithValidatedExecutableTypesContainingNONETest extends AbstractTCKTest {
	...
	public void testGetDefaultValidatedExecutableTypesStripsNONEIfNONEIsContained() {
		...
		assertThat( bootstrapConfiguration.getDefaultValidatedExecutableTypes() ).isEqualTo( EnumSet.of( ExecutableType.CONSTRUCTORS, ExecutableType.GETTER_METHODS, ExecutableType.NON_GETTER_METHODS ) );
	}
}
